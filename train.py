...
print(hidden_layer)
ffsnn = FFSN_MultiClass(784, hidden_layer, 10)
enc = OneHotEncoder()
...
ffsnn.fit(X1_train, y_train, epochs=arguments.epochs, learning_rate=arguments.learning_rate, batch_size = arguments.batch_size ,batch = 'm_B',algorithm = arguments.optimizer,act_func = arguments.activation, intialize_method = arguments.weight_init,loss_type = arguments.loss,l2_norm = False)
